...
class GenresAdapter(private val isSpecial: Boolean = false, private val listener: OnGenreClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val view = when (isSpecial) {
            false -> {
                LayoutInflater.from(parent.context).inflate(R.layout.item_genre_regular, parent, false)
            }
            true -> {
                LayoutInflater.from(parent.context).inflate(R.layout.item_genre_special, parent, false)
            }
        }
