...
interface ContinueWatchingRepository {
    ...
    suspend fun updateContinueWatching(token: String, contentId: Int, title: String, url: String, thumbnail: String, duration: Int, currentPosition: Int, series: Int): Flow<Resource<Int>>
